...
## 이제 어떻게 되는가
```java -XmsXG -XmxYG [aikar/velocity] -jar Radioactive-LeavesClip-1.20.6-R0.1-SNAPSHOT-reobf.jar``` 명령어를 실행할 시, 서버는 동작하지만,
로그가 다음과 같이 출력됩니다.
```
...
[21:17:02 ERROR]:
[21:17:02 ERROR]: *******************************************************
[21:17:02 WARN]: Warning! Plazma may cause unexpected problems, so be sure to test it thoroughly before using it on a public server.
[21:17:02 ERROR]: *********************** CAUTION ***********************
[21:17:02 ERROR]: This version is a development version of Plazma.
